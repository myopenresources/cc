...
export class ColorPickerComponent implements ControlValueAccessor, AfterViewChecked, OnDestroy {
  ...
  alignPanel() {
    if (this.appendTo)
      Utils.absolutePosition(this.panelViewChild.nativeElement, this.inputViewChild.nativeElement);
    else
      Utils.relativePosition(this.panelViewChild.nativeElement, this.inputViewChild.nativeElement);
  }
