              ...
              <div class="row c-mb15">
                    <div  class="col-md-12">
                        <div class="card-deck"  c-image-viewer (onViewInit)="onViewInit($event)">
                                <div class="card">
                                    <img class="card-img-top" src="assets/img/demo/cc/cc-1.png"  style="width:100%;height:60%">
                                ...
                                <div class="card">
                                    <img class="card-img-top" src="assets/img/demo/cc/cc-2.png" alt="主页面" style="width:100%;height:60%">
                                    <div class="card-block">
                                ...
                                <div class="card">
                                    <img class="card-img-top" src="assets/img/demo/cc/cc-3.png" alt="头像更换" style="width:100%;height:60%">
                                    <div class="card-block">
               ...
               <div class="row c-mb15">
                  <div  class="col-md-12">
                       <span class="text-danger">点击查看大图&gt;&gt;</span> <img data-original="assets/img/demo/cc/cc-3.png" src="assets/img/demo/cc/cc-1.png" c-image-viewer [options]="options"  style="width:20px;height:20px">
                   </div>
               </div>
